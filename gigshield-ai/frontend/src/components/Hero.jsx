  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '4rem', alignItems: 'center' }}>
        ...
        >
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(255,255,255,0.05)', padding: '6px 16px', borderRadius: '100px', border: '1px solid rgba(255,255,255,0.1)', marginBottom: '1.5rem', fontSize: '0.8rem', fontWeight: 600, color: '#06b6d4' }}>
            <span style={{ display: 'inline-block', width: '6px', height: '6px', background: '#06b6d4', borderRadius: '50%' }}></span>
            Hackathon Winner Prototype 2026
          </div>
